...
<head>
    ...
    <meta charset="utf-8" />
    <title>Sign In | Url Shortner</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <p class="mt-3 fs-15 fw-medium">Url Shortner Admin</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="{{ session('flash_error') ? 'text-danger' : 'text-muted' }}">
                                        {{ session('flash_error') ? session('flash_error') : 'Sign in to continue to Admin.' }}
                                    </p>
                                </div>
                                <div class="p-2 mt-4">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                ...
                                </script> Url Shortner. Crafted with <i
                                    class="mdi mdi-heart text-danger"></i> by Vjai
                            </p>
                        </div>
                    </div>
                </div>
